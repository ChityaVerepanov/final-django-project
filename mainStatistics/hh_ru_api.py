...
def fetch_vacancies():
    url = 'https://api.hh.ru/vacancies?per_page=10&professional_role=96&order_by=publication_time&text=web develop, Web-разработчик, веб разработчик, web разработчик, web programmer, web программист, веб программист, битрикс разработчик, bitrix разработчик, cms разработчик,  joomla разработчик, drupal developer, wordpress developer,'
